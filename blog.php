							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="blog-post-thumb big">
										...
										<ul class="post-meta">
											<li><a href="#"><span class="icon fa fa-user"></span>by Turing</a></li>
											<li><a href="#"><span class="icon fa fa-comment-o"></span>3 Comments </a></li>
										</ul>
										<h3>
											<a href="blog-single.php">Turing Expands the Leadership Team with David Lin, Controller</a>
										</h3>
										<div class="text">
										...
										<a href="blog-single.php" class="btn-primary-line">Read More</a>
									</div>
								</div>
								<!-- ***** Blog Post Big End ***** -->
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-post-thumb">
										...
										<h3>
											<a href="blog-single.php">Turing Partners with Velocloud to Deliver Managed SD-WAN</a>
										</h3>
										<div class="text">
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-post-thumb">
										...
										<h3>
											<a href="blog-single.php">Corporate IT Solutions Adds Neva Senior Account Executive</a>
										</h3>
										<div class="text">
